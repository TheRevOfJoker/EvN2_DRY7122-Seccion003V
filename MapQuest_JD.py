...
def calcular_distancia(ciudad_origen, ciudad_destino):
    url = f'http://www.mapquestapi.com/directions/v2/route?key=Tg0X4VYs0gsC85iQCTEPsBB9zThg2QeB&from={ciudad_origen}&to={ciudad_destino}'
...
# Programa principal
print("Conoce los datos de tu viaje con MapQuest!")
print("¡Fecha Y Hora De Hoy!",asctime(localtime()))
...
# Salida del programa con la letra "D"
while True:
    opcion = input("Presione 'D' para salir: ")
    if opcion.lower() == 'd':
        break
